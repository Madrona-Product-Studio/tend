...
const SEED_VERSION = 2; // bump to force a clean reseed in dev
const now = Date.now();
...
const beds: Bed[] = [
  ...
  B('b04', 'z1', 'Z1·B04', 'Peppers & Eggplant', 'vigo-wicking', 'Vigo — wicking floor', 'Full sun · hot', 'Fruiting', { state: { reservoirLevel: 0.6, irrigationOn: false } }),
